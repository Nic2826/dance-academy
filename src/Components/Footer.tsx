  ...
  return (
    <div className="Footer">
      <div className="Footer-social">
        <img className="Footer-social-image" src="/public/ig.png" alt="Instagram icon" />
        <a className="Footer-social-item" href="https://www.instagram.com/heels_bucaramanga/?hl=en" target="_blank">Instagram</a>
      </div>
        
        <div className="Footer-social">
          <img className="Footer-social-image" src="/public/tiktok.png" alt="TikTok icon" />
          <a className="Footer-social-item" href="https://www.tiktok.com/@heelsbucaramanga" target="_blank">TikTok</a>
        </div>
        
        <div className="Footer-social">
          <img className="Footer-social-image" src="/public/whatsapp.png" alt="WhatsApp icon" />
